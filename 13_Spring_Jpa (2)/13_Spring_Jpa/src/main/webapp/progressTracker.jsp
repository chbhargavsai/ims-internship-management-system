...
<div class="content">
    ...
    <p>Your current internship applications and their statuses:</p>
    <ul>
        <li>Software Developer Internship - Under Review</li>
        <li>Data Analyst Internship - Interview Scheduled</li>
        <li>Web Developer Internship - Application Submitted</li>
    </ul>
</div>
